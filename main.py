    ...
    model_config = {
        "json_schema_extra": {
            "examples": [
                {
                    "tasks": [
                    ["nom feature 1",10, 0.1, 0.5, 0, 0, 0],
                    ["nom feature 2",13, 1, 0.5, 0.25, 1, 0.75],
                    ["nom feature 3",5, 0, 0.25, 0, 0.75, 0.1],
                    ["nom feature 4",3, 0, 0.1, 0, 0.1, 0],
                    ["nom feature 5",3, 0, 0.1, 0, 0.1, 0]
                    ],
                    "maxLoad": 1.1
                }
            ]
